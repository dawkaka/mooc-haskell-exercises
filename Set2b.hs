...
countdown' n str = if n == 0 then str ++ "Liftoff!" else countdown' (n - 1) (str ++ show n ++ "... ")
...
smallestDivisor n = smallestDivisor' n n 0

smallestDivisor' :: Integer -> Integer -> Integer -> Integer
smallestDivisor' _ 1 cur = cur
smallestDivisor' d n cur = if mod d n == 0 then smallestDivisor' d (n-1) n else smallestDivisor' d (n-1) cur
